-- ============================================================
-- DIAGNOSTIC v7: Full step-by-step test (center 21 is now free)
-- Find which step fails after LOAD_BANK_PARAMETERS.
--
...
-- Insert test data (same as Spring Boot)
